---
title: "Mixed models and within-designs"
author: "Léo Belzile"
date: "`r Sys.Date()`"
output:
...
- In **R**, the notation with `lme4` package is `(1|group1/group2)` to mean `group2` is nested within `group1`. This formula expands to 
