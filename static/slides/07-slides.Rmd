...
![](`r knitr::fig_chunk("plotblocking", "png")`)
...
```{r popcorn_qqplot, echo = TRUE, fig.show = 'hide'}
...
![](`r knitr::fig_chunk("popcorn_qqplot", "png",)`)
All points fall roughly on a straight line.

]

.panel[.panel-name[**R** code]
```{r popcorn_plot, echo = TRUE, fig.show = 'hide', message = FALSE}
popcorn %>% 
...
![](`r knitr::fig_chunk("popcorn_plot", "png")`)
...
.small[
```{r plannedcomparisonspopcorn, echo = TRUE}
library(emmeans)
# marginal means
...
```{r plannedcomparisons2popcorn, echo = TRUE}
