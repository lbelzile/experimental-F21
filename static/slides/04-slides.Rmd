...
.box-2.medium.sp-after-half[Multiple testing]


--
  
.box-3.medium.sp-after-half[Statistical fallacies and the reproducibility crisis]
...
$$V_i =\begin{cases} 1 & \text{type I error for } \mathscr{H}_{0i}\quad  (R_i=1 \text{ and  }\mathscr{H}_{0i} \text{ is true}) \\\
0 & \text{otherwise} 
\end{cases}$$
