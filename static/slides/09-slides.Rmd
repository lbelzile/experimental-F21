...
.box-4.large.sp-after-half[Model assumptions]
---
layout: false
name: ancova
...
kableExtra::kable(jtools::tidy(car::Anova(model2, model1, type = 3)), 
		 col.names = c("term",
			 "sum of squares",
			 "df",
			 "statistic",
...
Fit the model with an interaction `condition*prior`. A significative interaction (small $p$-value) indicates that the slopes differ per condition group.
]
]
]
---
...
Assumptions give us leverage for designing tests and models

.box-4-inv[Linear model assumptions]

.float-left.center[.box-4[linearity] .box-4[equal variance] .box-4[normality] .box-4[independence]]
