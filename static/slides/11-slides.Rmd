...
- Single factor within-subject: $A \times S$, measurements for every subjects of each level of $A$.
- Two-factor within-subject: $A \times B \times S$, where every subject is assigned to $ab$ experimental factor combinations
- Two-factor mixed design: $A \times (B \times S)$: same as above, but with $A$ fixed and $B$ random


---

# Example of within design: Curley et al. (in press)
