...
The null hypothesis is $\mathscr{H}_0: \boldsymbol{\mu}_1 = \cdots = \boldsymbol{\mu}_J$ against the alternative that at least one vector is diffferent from the rest. The null imposes $(J-1) \times p$ restrictions on the parameters.
...
The null distribution is Hotelling's $T^2$, but a modifification of the test statistic can be approximated by a $F$ distribution.
